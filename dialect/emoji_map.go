...
// Code generated from emoji-toolkit (JoyPixels) emoji.json
// (https://github.com/joypixels/emoji-toolkit — the shortname
// convention Atlassian's emoji service uses); regenerate by
// rebuilding this map from a newer emoji.json. DO NOT EDIT BY HAND.
